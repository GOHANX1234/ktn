...
void LogShaders(){
    ...
    if (dlsym_error) {
        ...
        shadowhook_hook_func_addr((void*)p_glGetUniformLocation, (void*)new_glGetUniformLocation, (void**)&old_glGetUniformLocation);
    }
}
...
void Wallhack() {
    ...
    if (dlsym_error) {
        ...
        shadowhook_hook_func_addr((void*)p_glDrawElements, (void*)new_glDrawElements, (void**)&old_glDrawElements);
    }
}
